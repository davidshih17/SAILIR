#!/usr/bin/env python
"""Compare the *_conefix pentagonbox arms against the *_primefix references:
...
ARMS = [("gate_small_conefix", "gate_small_primefix"),
        ("m1_conefix", "m1_primefix"),
        ("m2_conefix", "m2_primefix"),
        ("m3_conefix", "m3_primefix")]
